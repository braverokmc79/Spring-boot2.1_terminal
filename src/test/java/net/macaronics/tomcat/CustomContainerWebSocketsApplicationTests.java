...
import net.macaronics.tomcat.CustomContainerWebSocketsApplicationTests.CustomContainerConfiguration;
import net.macaronics.tomcat.client.GreetingService;
import net.macaronics.tomcat.client.SimpleClientWebSocketHandler;
